...
export function getRigorousRelationship(
    ...
    if (tNode.createdByMemberId && !eq(tNode.createdByMemberId, vId)) {
        ...
        if (creator) {
            ...
            // 3. 终极级联推算映射表 (基于闽系全路径逻辑链条：同宗为亲、同父为亲、同母为表)
            const bridgeMap: Record<string, Record<string, string>> = {
                ...
                "姑婆": { "儿子": "表叔", "女儿": "表姑" },
                "姨婆": { "儿子": "表叔", "女儿": "表姑" },
                "亲伯": { "儿子": "亲兄弟姐妹", "女儿": "亲兄弟姐妹" },
                "亲叔": { "儿子": "亲兄弟姐妹", "女儿": "亲兄弟姐妹" },
                "亲姑": { "儿子": "表兄弟姐妹", "女儿": "表兄弟姐妹" },
                "大伯": { "儿子": "亲兄弟姐妹", "女儿": "亲兄弟姐妹" },
                "伯父": { "儿子": "亲兄弟姐妹", "女儿": "亲兄弟姐妹" },
                "叔叔": { "儿子": "亲兄弟姐妹", "女儿": "亲兄弟姐妹" },
                "小叔": { "儿子": "亲兄弟姐妹", "女儿": "亲兄弟姐妹" },
                "婶婶": { "儿子": "亲兄弟", "女儿": "亲姐妹" },
                "伯母": { "儿子": "亲兄弟", "女儿": "亲姐妹" },
                "姑姑": { "儿子": "表兄弟姐妹", "女儿": "表兄弟姐妹" },
                "舅舅": { "儿子": "表哥/弟", "女儿": "表姐/妹" },
                "舅妈": { "儿子": "表哥/弟", "女儿": "表姐/妹", "姑姑": "妗婆", "爸爸": "妗公" },
                "阿姨": { "儿子": "表哥/弟", "女儿": "表姐/妹" },
                "姨妈": { "儿子": "表哥/弟", "女儿": "表姐/妹" },
                "亲兄弟": { "儿子": "亲侄子", "女儿": "亲侄女" },
                "亲姐妹": { "儿子": "亲外甥", "女儿": "亲外甥女" },
